...
class MSHyperPose(MSTransPoseNet):
    ...
    def __init__(self):
        ...
        # Hyper networks
        # =========================================
        self.hyper_dim_t = 256
        self.hyper_t_hidden_scale = 0.5
        ...
        self.hypernet_rot_fc_h2 = nn.Linear(decoder_dim, 3 * (self.hyper_dim_rot + 1))
        ...
        self.regressor_hyper_rot = PoseRegressorHyper(decoder_dim, self.hyper_dim_rot, 3, hidden_scale=1.0)
