...
class MSTransPoseNet(nn.Module):
    ...
    def __init__(self):
        ...
        config = {}
        config["backbone"] = '/home/dev/git/hyperpose/models/backbones/efficient-net-b0.pth'
        config["learn_embedding_with_pose_token"] = False
        num_scenes = 4
        self.backbone = build_backbone(config)

        config_t = {**config, "num_encoder_layers": 4, "num_decoder_layers": 4}
        config_rot = {**config, "num_encoder_layers": 4, "num_decoder_layers": 4}
