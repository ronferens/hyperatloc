...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_dir', type=str, default='/media/dev/storage1')
        ...
        self.parser.add_argument('--scene', type=str, default='full')
        ...
        self.parser.add_argument('--logdir', type=str, default='/media/dev/storage1/robotcar_lr1e6')
        ...
        self.parser.add_argument('--viz', type=bool, default=False)
